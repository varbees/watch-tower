    ...
    <div className='relative max-w-auto mx-auto w-full m-auto  '>
      {banners.value.length > 0 && (
        <div>
          ...
          ></div>
          <div className='absolute bottom-[60px] right-5 text-white text-2xl md:text-3xl lg:text-4xl brightness-125 font-semibold py-2 px-3 bg-black/60 rounded-md italic'>
            {banners.value[curInd.value]?.title}
          </div>
          <div
            className='absolute top-[40%] -translate-x-0 -translate-y-[-50%] left-5 rounded-full p-2 bg-black/40 text-white cursor-pointer hover:bg-black/50 duration-300'
            onClick={() =>
              curInd.value === 0
          ...
          <div
            className='absolute top-[40%] -translate-x-0 -translate-y-[-50%] right-5 rounded-full p-2 bg-black/40 text-white cursor-pointer hover:bg-black/50 duration-300'
            onClick={() => {
              curInd.value < banners.value.length - 1
                ? curInd.value++
                : (curInd.value = 0);
